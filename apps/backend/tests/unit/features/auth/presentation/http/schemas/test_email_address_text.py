"""Unit tests of the shared pre-normalization email request type."""
...
from job_status_found.features.auth.presentation.http.schemas.password_sign_in_request import (
