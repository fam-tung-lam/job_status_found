...
from job_status_found.features.auth.presentation.http.v1.helpers.clear_refresh_cookie import (
    clear_refresh_cookie,
)
from job_status_found.features.auth.presentation.http.v1.refresh_cookie_settings import (
    RefreshCookieSettings,
)
from job_status_found.features.auth.presentation.http.v1.schemas.refresh_session_request import (
...
async def sign_out(
    ...
    Raises:
        SessionRefreshOriginNotAllowedFailure: A cookie request lacks an allowed Origin.
    """
