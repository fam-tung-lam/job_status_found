...
| Evidence                             | Where                                                                                                                                                                                                                                             |
|--------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Three branches, stored state, email  | `tests/integration/features/auth/presentation/http/v1/test_sign_up_controller.py`: one test per branch against PostgreSQL and Mailpit                                                                                                               |
