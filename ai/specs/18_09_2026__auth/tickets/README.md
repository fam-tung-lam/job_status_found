...
flowchart LR
    ...
    T07["T-07 App sign-in and restore"]
    ...
    T08["T-08 App registration<br>(waits on DEC-1)"]
...
| 7     | [T-07](07-app-sign-in-and-session-restore.md)                    | A verified person signs in on the app and stays signed in                                        | T-05, T-06         | §5, §11.1, §11.2, §13, §14                           |
| 8     | [T-08](08-app-registration-and-email-verification.md)            | A new visitor registers in the app and verifies the emailed code                                 | T-07, DEC-1        | §5, §6.1, §11.1, §11.2                               |
| 9     | [T-09](09-password-reset-request.md)                             | A person requests a password reset link from the forgot-password page                            | T-07               | §6.2, §7, §9, §11.3                                  |
| 10    | [T-10](10-password-reset-confirm.md)                             | A person sets a new password from the reset link                                                 | T-09               | §6.2, §7, §11.1, §11.3                               |
| 11    | [T-11](11-app-sign-out.md)                                       | A signed-in person signs out of the app                                                          | T-07, DEC-2        | §7, §11.1                                            |
| 12    | [T-12](12-password-change-api.md)                                | A signed-in person changes an existing password                                                  | T-06               | §5, §6.2, §7, §9                                     |
| 13    | [T-13](13-session-list-and-revocation-api.md)                    | A signed-in person lists and revokes their sessions                                              | T-06               | §7, §8 rule 3, ERD                                   |
| 14    | [T-14](14-sign-in-and-ip-throttles.md)                           | Repeated attempts are throttled per account and per IP                                           | T-09               | §4, §7, §9, §10                                      |
| 15    | [T-15](15-breached-password-rejection.md)                        | Passwords found in known breaches are rejected                                                   | T-10, T-12         | §4, §6.2, §7, §9, §10                                |
| 16    | [T-16](16-purge-expired-auth-records.md)                         | Expired auth records and deleted accounts are purged on schedule                                 | T-01               | §6.6, §10, ERD                                       |
| 17    | [T-17](17-google-browser-flow-sign-in-api.md)                    | A person signs in with Google through the browser flow                                           | T-14               | D-5, D-7, §3, §6.4, §6.5, §7, §9, §10, §12, §15      |
| 18    | [T-18](18-google-sign-in-existing-email-api.md)                  | A Google sign-in whose email already has an account links safely or refuses                      | T-17               | D-5, §6.5, §9                                        |
| 19    | [T-19](19-app-continue-with-google.md)                           | A person continues with Google in the app on the web, iOS, and Android                           | T-08, T-17, DEC-3  | §3, §4, §6.4, §11.1, §11.2, §14, §15                 |
| 20    | [T-20](20-account-deletion-with-recent-authentication.md)        | A signed-in person deletes their account after a fresh password proof                            | T-06               | §5, §6.6, §7, §8 rule 5                                   |
| 21    | [T-21](21-unlink-provider-api.md)                                | A person unlinks Google while keeping a way to sign in                                           | T-17, T-20         | §5, §7, §8 rule 3, ERD                                    |
| 22    | [T-22](22-set-first-password-api.md)                             | A social-only person sets a first password                                                       | T-12, T-17, T-20, DEC-4 | §5, §6.2, §7                                    |
| 23    | [T-23](23-link-google-api.md)                                    | A signed-in person links a Google identity                                                       | T-17, T-20, DEC-5  | §5, §6.4, §6.5, §7, §9                               |
| 24    | [T-24](24-reauthenticate-with-google-api.md)                     | A signed-in person re-authenticates with Google                                                  | T-17, T-20, DEC-5  | §5, §6.4, §6.5, §7                                   |
| 25    | [T-25](25-android-native-google-sign-in.md)                      | An Android person signs in with the native Google sheet                                          | T-18, T-19         | §3, §4, §6.3, §7, §10, §11.1, §12, §14               |
| 26    | [T-26](26-email-change-api.md)                                   | A signed-in person changes their email address                                                   | T-20, DEC-6        | §5, §7, §9, ERD                                      |
